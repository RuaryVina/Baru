                ...
                <tbody>
                    ...
                    <?php foreach ($subMenu as $sm) : ?>
                        <tr>
                            ...
                            <td><?= $sm['is_active']; ?></td>
                            <td>
                                <a href="" class="badge badge-success" data-toggle="modal" data-target="#modalEditSubMenu<?= $sm['id']; ?>">edit</a>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="from-check">
                            <input type="checkbox" class="from-check-input" name="is_active" value="1" id="is_active" checked>
