...
class Auth extends CI_Controller
{
    ...
    public function _sendEmail($token, $type)
    {
        ...
        $config = [
            ...
            'smtp_user' => 'webtugas35@gmail.com',
            'smtp_pass' => '123456web',
            'smtp_port' => 465,
            'mailtype'  => 'html',
            'charset'   => 'utf-8',
        ...
        $this->email->from('webtugas35@gmail.com', 'Web PWPB');
        $this->email->to($this->input->post('email'));

        if ($type == 'verify') {
            # code...
            $this->email->subject('Account Verification');
            $this->email->message('Click this link to verify you account : <a href="' . base_url() . 'auth/verify?email=' . $this->input->post('email') . '&token=' . urlencode($token) . '">Activates</a>');
        } elseif ($type == 'forgot') {
